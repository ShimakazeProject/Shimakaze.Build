...
using IniDocument = Shimakaze.MSBuild.Model.UnitIniDocument;
using IniSection = Shimakaze.MSBuild.Model.UnitSection;


namespace Shimakaze.MSBuild.Serialization;
